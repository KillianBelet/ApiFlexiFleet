 ...
 */
class getAgencyProviderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AgencyProviderRepository' shared autowired service.
     *
     * @return \App\Repository\AgencyProviderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AgencyProviderRepository.php';

        return $container->privates['App\\Repository\\AgencyProviderRepository'] = new \App\Repository\AgencyProviderRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
