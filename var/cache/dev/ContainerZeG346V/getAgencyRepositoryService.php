 ...
 */
class getAgencyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AgencyRepository' shared autowired service.
     *
     * @return \App\Repository\AgencyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AgencyRepository.php';

        return $container->privates['App\\Repository\\AgencyRepository'] = new \App\Repository\AgencyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
