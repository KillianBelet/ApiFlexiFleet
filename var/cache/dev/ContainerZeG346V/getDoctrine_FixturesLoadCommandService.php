...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(($container->privates['App\\Repository\\AgencyRepository'] ?? $container->load('getAgencyRepositoryService')), ($container->privates['App\\Repository\\ProviderRepository'] ?? $container->load('getProviderRepositoryService'))), 'groups' => []]]);
